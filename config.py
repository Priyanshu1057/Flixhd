...
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://duopoly2k25_db_user:0ZnqXWHUiCj0gff9@cluster0.bzgi8vm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "https://concrete-amity-opsoft-b1d77acb.koyeb.app/3adca196c74366f9d2991580d3fc459015b8ae36")
...
#--------------------------------------------
HELP_TXT = "<b><blockquote>ᴛʜɪs ɪs ᴀɴ ғɪʟᴇ ᴛᴏ ʟɪɴᴋ ʙᴏᴛ ᴡᴏʀᴋ ғᴏʀ @FilmyflixHD</b></blockquote>"
ABOUT_TXT = "hi"
#--------------------------------------------
#--------------------------------------------
